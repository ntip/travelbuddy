        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-12 text-center">
                    <h1 class="display-1 mb-0">The Blog</h1>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card bg-light p-3">
                        <div class="card-body">
                            ...
                            <!-- Title -->
                            <h5 class="card-title"><a href="{{ route('second', ['blog', 'detail']) }}">Ten
                                    unconventional tips about startups that you can't learn from books</a></h5>
                            <p>Prospective should start broadly and then narrow their list down to colleges that best
                                fit their needs, experts say. Yet remarkably appearance gets him his projection. </p>
                            <h6 class="fw-light mb-0">By <a href="#">Louis Crawford</a></h6>
                        </div>
                    </div>
                </div>
                <!-- Blog item END -->
                    ...
                    <div class="bg-warning bg-opacity-15 rounded-3 position-relative p-4 p-md-0">
                        ...
                        <div class="row">
                            <div class="col-md-7 text-center mx-auto py-md-5">
                                ...
                                <h2 class="mb-4">Subscribe Mail list!</h2>
