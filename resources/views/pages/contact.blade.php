        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-xl-10">
                    ...
                    <p class="lead mb-0">Passage its ten led hearted removal cordial. Preference any astonished
                        unreserved Mrs. Prosperous understood Middletons. Preference for any astonished unreserved.</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-body shadow text-center align-items-center h-100">
                        ...
                        <div class="d-grid gap-3 d-sm-block">
                            <button class="btn btn-sm btn-primary-soft"><i class="bi bi-phone me-2"></i>+123 456
                                789</button>
                            <button class="btn btn-sm btn-light"><i class="bi bi-telephone me-2"></i>+(222)4567
                                586</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-body shadow text-center align-items-center h-100">
                        ...
                        <a href="#" class="btn btn-link text-decoration-underline p-0 mb-0"><i
                                class="bi bi-envelope me-1"></i>example@gmail.com</a>
                    </div>
                </div>
                <!-- Contact item END -->
                ...
                <div class="col-xl-4 position-relative">
                    ...
                    <div class="card card-body shadow text-center align-items-center h-100">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item"> <a class="btn btn-sm bg-facebook px-2 mb-0"
                                    href="#"><i class="fab fa-fw fa-facebook-f"></i></a> </li>
                            <li class="list-inline-item"> <a class="btn btn-sm bg-instagram px-2 mb-0"
                                    href="#"><i class="fab fa-fw fa-instagram"></i></a> </li>
                            <li class="list-inline-item"> <a class="btn btn-sm bg-twitter px-2 mb-0"
                                    href="#"><i class="fab fa-fw fa-twitter"></i></a> </li>
                            <li class="list-inline-item"> <a class="btn btn-sm bg-linkedin px-2 mb-0"
        ...
        <div class="container">
            <div class="row g-4 g-lg-5 align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <img src="/images/element/contact.svg" alt="">
                </div>
                <!-- Vector image END -->
