                        ...
                        <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="{{ route('second', ['account' , 'payment-details']) }}">Payment
                                            Details</a> </li>
                                    ...
                                    <li> <a class="dropdown-item" href="{{ route('second', ['account', 'delete'])  }}">Delete Profile</a> </li>
                                </ul>
                            </li>
