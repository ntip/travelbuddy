                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu min-w-auto" aria-labelledby="homeMenu">
                            ...
                            <li> <a class="dropdown-item" href="{{ route('second', ['hotel', 'index-chain']) }}">Hotel
                                    Chain</a></li>
                            <li> <a class="dropdown-item" href="{{ route('second', ['hotel', 'index-resort']) }}">Hotel
                                    Resort</a></li>
                            <li> <a class="dropdown-item"
                                    href="{{ route('second', ['flight', 'index-flight']) }}">Flight Home</a></li>
                            <li> <a class="dropdown-item" href="{{ route('second', ['tour', 'index-tour']) }}">Tour
                                    Home</a></li>
                            <li> <a class="dropdown-item" href="{{ route('second', ['cab', 'index-cab']) }}">Cabs
                                    Home</a></li>
                        </ul>
                    </li>
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item">
                    <a href="#" class="btn btn-sm btn-primary mb-0"><i
                            class="fa-solid fa-right-to-bracket me-sm-2"></i><span class="d-none d-sm-inline">Sign
                            Up</span></a>
                </li>
            </ul>
