                ...
                <div class="col-md-9">
                    <div class="card-body position-relative d-flex flex-column p-0 h-100">
                        ...
                        <h5 class="card-title mb-0 me-5"><a
                                href="{{ route('second', ['hotel', 'detail']) }}">Pride moon Village Resort
                                & Spa</a></h5>
        ...
        <div class="card shadow h-100">
            ...
            <div class="card-body">
                ...
                <div class="d-flex gap-4 mb-3">
                    <h6><span class="fw-light"><i class="bi bi-square-fill text-primary"></i>
                            Check-in:</span> 475 Guests</h6>
                    <h6><span class="fw-light"><i class="bi bi-square-fill text-info"></i>
                            Check-out:</span> 157 Guests</h6>
                </div>
                <!-- Apex chart -->
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        ...
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/04.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/05.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/06.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/08.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/02.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
            ...
            <div class="card-body p-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/09.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                        <!-- Avatar -->
                        <div class="flex-shrink-0">
                            <img src="/images/category/hotel/4by3/01.jpg" class="rounded h-60px"
                                alt="">
                        </div>
                        <!-- Info -->
                        <div class="ms-sm-3 mt-2 mt-sm-0">
