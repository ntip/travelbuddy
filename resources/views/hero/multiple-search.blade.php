        ...
        <div class="container">
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item align-items-center d-none d-sm-flex position-relative me-sm-3">
                    <!-- Icon -->
                    <a href="#" class="icon-md btn btn-light mb-0 p-0 flex-shrink-0"><i
                ...
                <li class="nav-item dropdown">
                    <a class="icon-md btn btn-light mb-0 p-0" href="#" id="languageDropdown" role="button"
                        data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <i class="bi bi-globe"> </i>
                    </a>
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end min-w-auto mt-2"
                ...
                <li class="nav-item ms-3">
                    <a href="{{ route('second', ['auth', 'sign-up']) }}" class="btn btn-sm btn-primary mb-0"><i
...
<main>
    ...
    <section class="pt-0">
        ...
        <div class="container-fluid"
            style="background-image:url(/images/bg/08.jpg); background-position: center left; background-size: cover;">
            <div class="row">
                <!-- Title -->
        ...
        <div class="container mt-n8">
            <div class="row">
                ...
                <div class="col-11 col-lg-8 col-xl-6 mx-auto">
                    <ul
                        class="nav nav-tabs nav-bottom-line nav-justified nav-responsive bg-mode rounded-top z-index-9 position-relative pt-2 pb-0 px-4">
                        <li class="nav-item">
                            <a class="nav-link mb-0 active" data-bs-toggle="tab" href="#tab-1-1"><i
                                    class="fa-solid fa-hotel fa-fw me-2"></i>Hotel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0" data-bs-toggle="tab" href="#tab-1-2"><i
                                    class="fa-solid fa-plane fa-fw me-2"></i>Flight</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0" data-bs-toggle="tab" href="#tab-1-3"><i
                                    class="fa-solid fa-globe-americas fa-fw me-2"></i>Tour</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0" data-bs-toggle="tab" href="#tab-1-4"><i
                    ...
                    <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="card-body p-4 pt-0">
                                    <div class="row g-4">
                                            ...
                                            <div class="form-icon-input form-fs-lg">
                                                <div class="dropdown guest-selector me-2">
                                                    <input type="text"
                                                        ...
                                                        placeholder="Select occupant" data-bs-auto-close="outside"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-icon-input form-fs-lg">
                                                <input type="text" class="form-control form-control-lg flatpickr"
                                                    data-date-format="d/m/y" placeholder="Select check-in date">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-icon-input form-fs-lg">
                                                <input type="text" class="form-control form-control-lg flatpickr"
                                                    data-date-format="d/m/y" placeholder="Select check-out date">
                                                <span class="form-icon"><i class="bi bi-calendar fs-5"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center pt-0">
                                        <a class="btn btn-lg btn-primary mb-n7" href="#">Search Hotel <i
                            ...
                            <form class="card shadow p-0">
                                ...
                                <div class="card-header p-4">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-lg-4 col-xl-6">
                                            <h5 class="mb-0"><i class="fa-solid fa-plane fa-fw me-2"></i>Flight
                                                Booking</h5>
                                        </div>
                                        <!-- Radio tab -->
                                        <div class="col-md-6 col-lg-4 col-xl-3 ms-auto">
                                            <div class="nav nav-pills" id="pills-tab" role="tablist">
                                                <div class="form-check form-check-inline active"
                                                    id="flight-one-way-tab" data-bs-toggle="pill"
                                                    data-bs-target="#flight-one-way" role="tab"
                                                    aria-controls="flight-one-way" aria-selected="true">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineRadioOptions" id="inlineRadio1" value="option1"
                                                        checked>
                                                    <label class="form-check-label" for="inlineRadio1">One Way</label>
                                                </div>
                                                <div class="form-check form-check-inline" id="flight-round-way-tab"
                                                    data-bs-toggle="pill" data-bs-target="#flight-round-way"
                                                    role="tab" aria-controls="flight-round-way"
                                                    aria-selected="false">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineRadioOptions" id="inlineRadio2" value="option2">
                                                    <label class="form-check-label" for="inlineRadio2">Round
                                                        Trip</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body p-4 pt-0">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <!-- One way tab START -->
                                        <div class="tab-pane fade show active" id="flight-one-way" role="tabpanel"
                                            aria-labelledby="flight-one-way-tab">
                                            <div class="row g-4">
                                                <!-- From -->
                                                <div class="col-md-6 position-relative">
                                                    <div class="form-icon-input form-size-lg form-fs-lg">
                                                        <select class="form-select js-choice"
                                                            ...
                                                            <option value="" selected>Flying from...</option>
                                                            <option>San Jacinto, USA</option>
                                                            <option>North Dakota, Canada</option>
                                                            <option>West Virginia, Paris</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-size-lg form-fs-lg">
                                                        <select class="form-select js-choice"
                                                            data-search-enabled="true">
                                                            <option value="" selected>Flying to...</option>
                                                            <option>San Jacinto, USA</option>
                                                            <option>North Dakota, Canada</option>
                                                            <option>West Virginia, Paris</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-fs-lg">
                                                        ...
                                                        <span class="form-icon"><i
                                                                class="bi bi-calendar fs-5"></i></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-fs-lg">
                                                        ...
                                                        <span class="form-icon"><i
                                                                class="bi bi-people fs-5"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Button -->
                                            <div class="text-center pt-0">
                                                <a class="btn btn-lg btn-primary mb-n7" href="#">Search Flight
                                                    <i class="bi bi-arrow-right ps-3"></i></a>
                                            </div>
                                        </div>
                                        <!-- One way trip END -->

                                        <!-- Round way tab START -->
                                        <div class="tab-pane fade" id="flight-round-way" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="tab-1-3">
                            <form class="card shadow p-0">
                                <!-- Card header -->
                                <div class="card-header p-4">
                                    <h5 class="mb-0"><i class="fa-solid fa-globe-americas fa-fw me-2"></i>Tour
                                        Booking</h5>
                                </div>
                                ...
                                <div class="card-body p-4 pt-0">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-icon-input form-size-lg form-fs-lg">
                                                <select class="form-select js-choice" data-search-enabled="true">
                                                    <option value="" selected>Select tour location</option>
                                                    <option>San Jacinto, USA</option>
                                                    <option>North Dakota, Canada</option>
                                                    <option>West Virginia, Paris</option>
                                                </select>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-icon-input form-size-lg form-fs-lg">
                                                ...
                                                <span class="form-icon"><i
                                                        class="fa-solid fa-person-skating fs-5"></i></span>
                                            </div>
                                        </div>
                                    </div> <!-- Row END -->
                                    ...
                                    <!-- Button -->
                                    <div class="text-center pt-0">
                                        <a class="btn btn-lg btn-primary mb-n7" href="#">Search Tour <i
                                                class="bi bi-arrow-right ps-3"></i></a>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="tab-pane fade" id="tab-1-4">
                            <form class="card shadow p-0">
                                ...
                                <div class="card-header d-sm-flex justify-content-between align-items-center p-4">
                                    <!-- Title -->
                                    <h5 class="mb-3 mb-sm-0"><i class="fa-solid fa-car fa-fw me-2"></i>Cab Booking
                                    </h5>

                                    <!-- Tabs -->
                                    <ul class="nav nav-pills nav-pills-dark" id="pills-tab-2" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link mb-0 rounded-start rounded-0 active"
                                                id="pills-one-way-2-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-one-way-2" type="button" role="tab"
                                                aria-selected="true">One Way</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link mb-0 rounded-end rounded-0"
                                                id="pills-round-way-2-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-round-way-2" type="button" role="tab"
                                                aria-selected="false">Road Trip</button>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="card-body p-4 pt-0">
                                    ...
                                    <div class="tab-content" id="pills-tabContent3">
                                        <!-- One way tab START -->
                                        <div class="tab-pane fade show active" id="pills-one-way-2" role="tabpanel"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6 position-relative">
                                                    <div class="form-icon-input form-size-lg form-fs-lg">
                                                        <select class="form-select js-choice"
                                                            data-search-enabled="true">
                                                            <option value="" selected>Select pickup location
                                                            </option>
                                                            <option>San Jacinto, USA</option>
                                                            <option>North Dakota, Canada</option>
                                                            <option>West Virginia, Paris</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-fs-lg">
                                                        <input type="text"
                                                            class="form-control form-control-lg flatpickr"
                                                            data-date-format="d/M/Y" placeholder="Select pickup date">
                                                        <span class="form-icon"><i
                                                                class="bi bi-calendar fs-5"></i></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-fs-lg">
                                                        <input type="text"
                                                            class="form-control form-control-lg flatpickr"
                                                            placeholder="Select pickup time" data-noCalendar="true"
                                            ...
                                            <!-- Button -->
                                            <div class="text-center pt-0">
                                                <a class="btn btn-lg btn-primary mb-n7" href="#">Search Cabs <i
                                                        class="bi bi-arrow-right ps-3"></i></a>
                                            </div>
                                        </div>
                                        <!-- One way tab END -->
                                        ...
                                        <!-- Round way tab START -->
                                        <div class="tab-pane fade" id="pills-round-way-2" role="tabpanel"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-icon-input form-size-lg form-fs-lg">
                                                        <select class="form-select js-choice"
                                                            data-search-enabled="true">
                                                            <option value="" selected>Select drop location
                                                            </option>
                                                            <option>San Jacinto, USA</option>
                                                            <option>North Dakota, Canada</option>
                                                            <option>West Virginia, Paris</option>
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-icon-input form-fs-lg">
                                                        <input type="text"
                                                            class="form-control form-control-lg flatpickr"
                                                            data-date-format="d/M/Y" placeholder="Select return date">
                                                        <span class="form-icon"><i
                                                                class="bi bi-calendar fs-5"></i></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-3">
                                                    <div class="form-icon-input form-fs-lg">
                                                        <input type="text"
                                                            class="form-control form-control-lg flatpickr"
                                                            placeholder="Select return time" data-noCalendar="true"
                                                            data-enableTime="true">
                                                        <span class="form-icon"><i
                                                                class="bi bi-calendar fs-5"></i></span>
                                                    </div>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/beach.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/island.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/pool.svg" class="h-30px me-3" alt="">
                            <h6 class="card-title mb-0"><a href="#" class="stretched-link">Amazing Pools</a>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/camping.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/cabin.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/lake.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/park.svg" class="h-30px me-3" alt="">
                            <h6 class="card-title mb-0"><a href="#" class="stretched-link">National Park</a>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/cave.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/surf.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/farm.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/tower.svg" class="h-30px me-3" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                    <div class="card card-body bg-light h-100 align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
                            <img src="/images/element/desert.svg" class="h-30px me-3" alt="">
