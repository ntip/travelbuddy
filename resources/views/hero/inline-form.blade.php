...
@section('header')
<!-- Header START -->
<header class="header-sticky header-transparent">
    <!-- Logo Nav START -->
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                        ...
                        <li>
                            <div
                                ...
                                <span>Mode:</span>
                                <button type="button" class="btn btn-link nav-link mb-0 p-0"
                                ...
                                <button type="button" class="btn btn-link nav-link mb-0 p-0 active"
...
<main>
    ...
    <section class="position-relative py-xl-9"
        style="background-image:url(/images/bg/10.jpg); background-position: center left; background-size: cover;">
            ...
            <div class="row">
                <div class="col-lg-10 m-auto text-center position-relative z-index-9">
                    ...
                    <form class="form-control-inline my-5">
                        ...
                        <!-- Button -->
                        <button class="icon-xxl bg-primary btn-dark-hover rounded-circle btn fs-6 text-white p-0 mt-4"
