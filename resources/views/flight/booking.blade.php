                        ...
                        <div class="card-body p-0 mt-3">
                            ...
                            <form class="bg-light rounded-3 p-4">
                                ...
                                <div class="row g-3">
                                    <!-- Card number -->
                                    <div class="col-12">
                                        <label class="form-label"><span class="h6 fw-normal">Card Number
                                                *</span></label>
                                    ...
                                    <!-- Expiration Date -->
                                    <div class="col-md-6">
                                        <label class="form-label"><span class="h6 fw-normal">Expiration date
                                                *</span></label>
                                    ...
                                    <!-- Card name -->
                                    <div class="col-12">
                                        <label class="form-label"><span class="h6 fw-normal">Name on Card
                                                *</span></label>
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mt-2">
                                        ...
                                        <h6 class="fw-normal mb-0">Mumbai <i class="bi bi-arrow-right"></i> New York
                                        </h6>
                                    </div>
