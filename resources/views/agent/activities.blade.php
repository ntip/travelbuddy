...
<main>
    ...
    <section class="pt-0">
        <div class="container vstack gap-4">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="fs-4 mb-0"><i class="bi bi-bell fa-fw me-1"></i>Activities</h1>
                </div>
            </div>
            <!-- Title END -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-sm-center me-4 ms-sm-0">
                                    ...
                                    <!-- Title -->
                                    <div class="ms-3">
                                        <h6 class="fw-light m-0">Your listing <a href="#"
                                                class="text-primary">Courtyard by Marriott New York </a>has been
                                            approved</h6>
                                ...
                                <div class="d-flex gap-2 mt-2 mt-sm-0">
                                    ...
                                    <a href="#" class="btn btn-sm btn-danger-soft"><i
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-sm-center me-4 ms-sm-0">
                                    ...
                                    <!-- Title -->
                                    <div class="ms-3">
                                        <h6 class="fw-light m-0">Louis Ferguson booked your <span
                                                class="fw-bold">Hotel Baljees Regency </span>Hotel room</h6>
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-sm-center me-4 ms-sm-0">
                                    ...
                                    <!-- Title -->
                                    <div class="ms-3">
                                        <h6 class="fw-light m-0">Someone left a review on <span class="fw-bold">Park
                                                Plaza Lodge Hotel </span> listing</h6>
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-sm-center me-4 ms-sm-0">
                                    ...
                                    <!-- Title -->
                                    <div class="ms-3">
                                        <h6 class="fw-light m-0">Amanda Reed Cancel booking in <a href="#"
                                                class="text-primary">Courtyard by Marriott New York </a>hotel</h6>
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-sm-center me-4 ms-sm-0">
                                    ...
                                    <!-- Title -->
                                    <div class="ms-3">
                                        <h6 class="fw-light m-0">Lori Stevens booked your <span class="fw-bold">Pride
                                                moon Village Resort & Spa </span>Hotel room</h6>
