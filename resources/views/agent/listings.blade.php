                    ...
                    <div class="offcanvas-body p-3 p-xl-0">
                        ...
                        <div class="navbar navbar-expand-xl">
                            <ul class="navbar-nav navbar-offcanvas-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('second', ['agent', 'dashboard']) }}"><i
                                            class="bi bi-house-door fa-fw me-1"></i>Dashboard</a> </li>

                                <li class="nav-item"> <a class="nav-link active" href="{{ route('second', ['agent' , 'listings']) }}"><i
                                            class="bi bi-journals fa-fw me-1"></i>Listings</a> </li>

                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('second', ['agent', 'bookings']) }}"><i
                                            class="bi bi-bookmark-heart fa-fw me-1"></i>Bookings</a> </li>

                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('second', ['agent', 'activities']) }}"><i
                                            class="bi bi-bell fa-fw me-1"></i>Activities</a> </li>

                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('second', ['agent', 'earnings']) }}"><i
                                            class="bi bi-graph-up-arrow fa-fw me-1"></i>Earnings</a> </li>

                                <li class="nav-item"> <a class="nav-link" href="{{ route('second', ['agent' , 'reviews']) }}"><i
                                            class="bi bi-star fa-fw me-1"></i>Reviews</a></li>

                                <li class="nav-item"> <a class="nav-link" href="{{ route('second', ['agent' , 'settings']) }}"><i
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-body border p-4 h-100">
                        ...
                        <div class="mt-auto text-primary-hover"><a href="#"
                                class="text-decoration-underline p-0 mb-0">View statement</a></div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-body border p-4 h-100">
                        ...
                        <div class="mt-auto text-primary-hover"><a href="#"
                                class="text-decoration-underline p-0 mb-0">View Bookings</a></div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-body border p-4 h-100">
                        ...
                        <p class="mb-2"><span class="text-danger me-1">102</span>Total Rooms</p>
                        <div class="mt-auto text-primary-hover"><a href="#"
                                class="text-decoration-underline p-0 mb-0">View Rooms</a></div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card border">
                        ...
                        <div class="card-header border-bottom">
                            <h5 class="card-header-title">My Listings <span
                                    class="badge bg-primary bg-opacity-10 text-primary ms-2">5 Items</span></h5>
                        </div>
                        ...
                        <div class="card-body vstack gap-3">
                            ...
                            <div class="card border p-2">
                                <div class="row g-4">
                                    <!-- Card img -->
                                    <div class="col-md-3 col-lg-2">
                                        <img src="/images/category/hotel/4by3/05.jpg" class="card-img rounded-2"
                                            alt="Card image">
                                    </div>
                            ...
                            <div class="card border p-2">
                                <div class="row g-4">
                                    <!-- Card img -->
                                    <div class="col-md-3 col-lg-2">
                                        <img src="/images/category/hotel/4by3/04.jpg" class="card-img rounded-2"
                                            alt="Card image">
                                    </div>
                                    ...
                                    <div class="col-md-9 col-lg-10">
                                        <div class="card-body position-relative d-flex flex-column p-0 h-100">
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title mb-0 me-5"><a
                                                    href="{{ route('second', ['hotel', 'detail']) }}">Carina Beach
                                                    Resort</a></h5>
                            ...
                            <div class="card border p-2">
                                <div class="row g-4">
                                    <!-- Card img -->
                                    <div class="col-md-3 col-lg-2">
                                        <img src="/images/category/hotel/4by3/06.jpg" class="card-img rounded-2"
                                            alt="Card image">
                                    </div>
                            ...
                            <div class="card border p-2">
                                <div class="row g-4">
                                    <!-- Card img -->
                                    <div class="col-md-3 col-lg-2">
                                        <img src="/images/category/hotel/4by3/08.jpg" class="card-img rounded-2"
                                            alt="Card image">
                                    </div>
