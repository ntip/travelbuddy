...
<main>
        ...
        <div class="container z-index-9 position-relative">
            <div class="row py-sm-5">
                ...
                <div class="col-xl-10 mx-auto">
                    <div
                        class="bg-blur bg-white bg-opacity-10 border border-light border-opacity-25 rounded-3 p-4 mt-5">
                        <!-- Form START -->
                        <form class="row g-3 justify-content-center align-items-center">
                            <div class="col-lg-5">
                                <!-- Input -->
                                <div class="form-input-dropdown position-relative">
                                    <input class="form-control form-control-lg me-1 ps-5" type="text"
                                        data-bs-toggle="dropdown" placeholder="What are you looking for..">
                                    <!-- dropdown button -->
                                    <ul class="dropdown-menu input-dropdown shadow rounded-0 rounded-bottom w-100">
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-building fa-fw text-primary me-2"></i>Hotels</a></li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-egg-fried fa-fw text-primary me-2"></i>Restaurants</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-airplane fa-fw text-primary me-2"></i>Flights</a></li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-cup-straw fa-fw text-primary me-2"></i>Bars</a></li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-tv fa-fw text-primary me-2"></i>Arts &
                                                Entertainment</a></li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-car-front fa-fw text-primary me-2"></i>Automotive</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-emoji-kiss fa-fw text-primary me-2"></i>Beauty &
                                                Spa</a></li>
                                        <li><a class="dropdown-item" href="#"><i
                                                    class="bi bi-fire fa-fw text-primary me-2"></i>Nightlife</a></li>
                                    </ul>
                                    <!-- Icon -->
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-mix-icon-input form-size-lg">
                                    <select class="form-select js-choice" data-search-enabled="true">
                                        <option value="" selected>Search hotel</option>
                                    ...
                                    <a href="#"
                                        class="h6 mb-0 position-absolute top-50 end-0 translate-middle pe-1">
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-2">
                    ...
                    <a href="#" class="h6 fw-normal text-primary mb-0">View all <i
                ...
                <div class="col-lg-10">
                    ...
                    <div class="tiny-slider arrow-round arrow-xs arrow-dark">
                        <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-edge="2"
                            data-dots="false" data-items-xl="5" data-items-lg="3" data-items-sm="2"
                            data-items-xs="1">
                            <!-- Slider item -->
                            <div>
                                <div class="card card-body bg-light text-center align-items-center">
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="47.9px" height="47.3px" viewBox="0 0 47.9 47.3"
                                                style="enable-background:new 0 0 47.9 47.3;" xml:space="preserve">
                            ...
                            <div>
                                <div class="card card-body bg-light text-center align-items-center">
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="43.4px" height="51px" viewBox="0 0 43.4 51"
                                                style="enable-background:new 0 0 43.4 51;" xml:space="preserve">
                                                <path class="fill-mode-inverse"
                            ...
                            <div>
                                <div class="card card-body bg-light text-center align-items-center">
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="43.7px" height="38.7px" viewBox="0 0 43.7 38.7"
                                                style="enable-background:new 0 0 43.7 38.7;" xml:space="preserve">
                                                <path class="fill-mode-inverse"
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="44px" height="44px" viewBox="0 0 44 44"
                                                ...
                                                <path class="fill-primary"
                                                    d="M6.4,23.4H5C5,32,12,39,20.6,39v-1.4C12.8,37.6,6.4,31.2,6.4,23.4z" />
                                            </svg>
                                        </figure>
                                    </div>
                            ...
                            <div>
                                <div class="card card-body bg-light text-center align-items-center">
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="42.7px" height="42.7px" viewBox="0 0 42.7 42.7"
                            ...
                            <div>
                                <div class="card card-body bg-light text-center align-items-center">
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="46.6px" height="53.3px" viewBox="0 0 46.6 53.3"
                                                style="enable-background:new 0 0 46.6 53.3;" xml:space="preserve">
                                                <path class="fill-primary"
        ...
        <div class="container">
            ...
            <div class="row mb-4 mb-sm-5">
                <div class="col-12 text-center">
                    ...
                    <p class="mb-0">Book your hotel with us and don't forget to grab an awesome hotel deal to save
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/01.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i
                                        class="fa-solid fa-building-columns fa-fw text-warning"></i> Museum</div>
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title me-2"><a
                                    href="{{ route('second', ['directory', 'detail']) }}">Portland New Art Museum</a>
                            </h5>
                        ...
                        <div class="card-footer border-top">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('second', ['directory', 'detail']) }}"
                                    class="btn btn-link p-0 mb-0">View detail<i
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/02.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i
                                        class="fa-solid fa-bag-shopping fa-fw text-warning"></i> Shopping</div>
                                <div class="badge text-bg-success">Open</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <!-- Title -->
                            <h5 class="card-title me-2"><a href="{{ route('second', ['directory', 'detail']) }}">JP
                                    Shopping Mall in California</a></h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/hotel/4by3/02.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i class="fa-solid fa-hotel fa-fw text-warning"></i>
                                    Hotel</div>
                                <div class="badge text-bg-success">Open</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title me-2"><a
                                    href="{{ route('second', ['directory', 'detail']) }}">Courtyard by Marriott New
                                    York</a></h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/03.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Title -->
                            <h5 class="card-title me-2"><a
                                    href="{{ route('second', ['directory', 'detail']) }}">Emperor Resort & Spa</a>
                            </h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/04.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i
                                        class="fa-solid fa-dumbbell fa-fw text-warning"></i> Gym</div>
                                <div class="badge text-bg-success">Open</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title me-2"><a
                                    href="{{ route('second', ['directory', 'detail']) }}">Phoenix Power Gym</a></h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/hotel/4by3/08.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i class="fa-solid fa-hotel fa-fw text-warning"></i>
                                    Hotel</div>
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title me-2"><a href="{{ route('second', ['directory', 'detail']) }}">Park
                                    Plaza Lodge Hotel</a>
                            </h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/05.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i class="fa-solid fa-car fa-fw text-warning"></i>
                                    Automotive</div>
                                <div class="badge text-bg-success">Open</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="badge bg-danger bg-opacity-10 text-danger mb-2">Recommended</div>
                            <!-- Title -->
                            <h5 class="card-title me-2"><a href="{{ route('second', ['directory', 'detail']) }}">Car
                                    Service & Repair</a></h5>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card shadow h-100">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="/images/category/directory/06.jpg" class="card-img-top" alt="Card image">
                            <!-- Overlay -->
                            <div class="card-img-overlay p-3 z-index-1">
                                <div class="badge text-bg-dark"><i
                                        class="fa-solid fa-champagne-glasses fa-fw text-warning"></i> Restaurant</div>
                                <div class="badge text-bg-danger">Closed</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title me-2"><a href="{{ route('second', ['directory', 'detail']) }}">El
                                    Torero Restaurant & Bar</a></h5>
    ...
    <section class="my-md-5"
        style="background-image:url(/images/about/11.jpg); background-position: center left; background-size: cover;">
        <div class="container">
            <div class="row py-lg-7">
                <div class="col-lg-6 ms-auto">
                    <h5 class="badge text-bg-white mb-3"><i class="bi bi-star-fill text-warning me-2"></i>Featured
                    </h5>
                    ...
                    <p class="text-white mb-4">Delivered dejection necessary objection do Mr prevailed. Mr feeling does
                        chiefly cordial in do. Water timed folly right aware if oh truth. Large above be to means.
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 position-relative">
                    ...
                    <p>Book your hotel with us and don't forget to grab an awesome hotel deal to save massive on your
                        stay.</p>
                    <img src="/images/about/09.jpg" class="rounded-3" alt="">
                    <!-- Svg decoration -->
                    <figure class="position-absolute bottom-0 end-0 me-lg-n5 mb-n3">
                        <svg class="fill-info" width="150px" height="133.5px" viewBox="0 0 150 133.5"
                            style="enable-background:new 0 0 150 133.5;" xml:space="preserve">
                            <path
                                d="M66.4,84.6c1,0,2,0.2,2.8,0c1.5-0.4,3.6-3.5,3.5-5.1c0-0.2-0.1-0.6-0.3-0.7c-0.8-0.4-1.6-0.8-2.4-1.2 c-0.5,0.8-2-0.1-2.2,1.3c-0.1,0.6-1.4,0.2-1,1.2C66,81.5,66.6,83,66.4,84.6 M62.3,78.2c0.3-0.4,0.6-0.8,0.7-1.3 c0.6-1.7,2-2.3,3.4-2.7c1-0.3,2-0.6,3.1-0.5c2.5,0.2,4.3,1.4,5.6,3.5c0.6,1,1.2,2,1.4,3.2c0.2,0.8,0.4,1.7,0.2,2.4 c-0.9,2.7-2.4,5-5.2,6.1c-0.8,0.3-1.6,0.5-2.4,0.8c-0.1,0-0.3,0.1-0.4,0c-2.1-1-4-2.1-5.2-4.2c-0.5-0.9-1-1.9-0.9-3 c0.2-1.3-0.4-2.7,0.4-4C62.8,78.5,62.6,78.4,62.3,78.2" />
                            <path
                    ...
                    <div class="row g-4 g-md-5">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex">
                                <!-- Svg icon -->
                                <figure>
                                    <svg width="50.1px" height="49.9px" viewBox="0 0 50.1 49.9"
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="mb-0">In no impression assistance contrasted she wishing justice
                                        hastily.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex">
                                <!-- Svg icon -->
                                <figure>
                                    <svg width="49.3px" height="56.1px" viewBox="0 0 49.3 56.1"
                                        style="enable-background:new 0 0 49.3 56.1;" xml:space="preserve">
                                        <path class="fill-primary"
                                        ...
                                        <path class="fill-primary"
                                            d="M19.3,9.8V5.6c0-0.5-0.4-0.9-0.9-0.9s-0.9,0.4-0.9,0.9v4.1c0,0.5,0.4,0.9,0.9,0.9S19.3,10.3,19.3,9.8z" />
                                    </svg>
                                </figure>
                                <div class="ms-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex">
                                <!-- Svg icon -->
                                <figure>
                                    <svg width="50.5px" height="44.2px" viewBox="0 0 50.5 44.2"
                                        style="enable-background:new 0 0 50.5 44.2;" xml:space="preserve">
                                        <path class="fill-primary"
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex">
                                <!-- Svg icon -->
                                <figure>
                                    <svg width="52px" height="58.3px" viewBox="0 0 52 58.3"
                                        style="enable-background:new 0 0 52 58.3;" xml:space="preserve">
                                        <path class="fill-primary"
    ...
    <section class="pt-0 pt-md-5">
        <div class="container">
            <div class="text-center position-relative py-5"
                style="background-image:url(/images/element/map.svg); background-position: center left; background-size: cover;">
                <!-- Avatar decoration -->
                <div class="avatar position-absolute top-50 end-0 mt-5 me-7">
                    <img class="avatar-img rounded-circle border border-2 border-light d-none d-md-block"
                        src="/images/avatar/09.jpg" alt="avatar">
                </div>
                <!-- Avatar decoration -->
                <div class="avatar avatar-lg position-absolute top-0 end-0 mt-5">
                    <img class="avatar-img rounded-circle border border-2 border-light d-none d-lg-block"
                        src="/images/avatar/05.jpg" alt="avatar">
                </div>
                <!-- Avatar decoration -->
                <div class="avatar position-absolute top-50 start-0 ms-5">
                    <img class="avatar-img rounded-circle border border-2 border-light d-none d-md-block"
                        src="/images/avatar/04.jpg" alt="avatar">
                </div>
                <!-- Avatar decoration -->
                        ...
                        <div class="tiny-slider dots-primary">
                            <div class="tiny-slider-inner" data-autoplay="true" data-arrow="false" data-dots="true"
                                ...
                                <div>
                                    ...
                                    <!-- Content -->
                                    <p class="h5 fw-light mb-3">"Size-like body someone had. Are conduct viewing boy
                                        minutes warrant the expense? Tolerably behavior may admit daughters offending
                                        her ask own. Praise effects wish change way and any wanted."</p>
                                ...
                                <div>
                                    ...
                                    <!-- Content -->
                                    <p class="h5 fw-light mb-3">"Are conduct viewing boy minutes warrant the expense?
                                        Tolerably behavior may admit daughters offending her ask own. Praise effects
                                        wish change way and any wanted."</p>
                                    <ul class="list-inline small mb-3">
                                        <li class="list-inline-item me-0"><i
                                                class="fa-solid fa-star text-warning"></i></li>
                                        <li class="list-inline-item me-0"><i
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/01.jpg" class="h-70px rounded-2"
                                            alt="">
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/02.jpg" class="h-70px rounded-2"
                                            alt="">
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/04.jpg" class="h-70px rounded-2"
                                            alt="">
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/05.jpg" class="h-70px rounded-2"
                                            alt="">
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/07.jpg" class="h-70px rounded-2"
                                            alt="">
                        ...
                        <div class="col-md-6">
                            <div class="card card-body h-100 p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Image and text -->
                                    <div class="d-flex align-items-center">
                                        <img src="/images/category/hotel/nearby/09.jpg" class="h-70px rounded-2"
                                            alt="">
        ...
        <div class="container">
            ...
            <div class="tiny-slider arrow-round arrow-blur arrow-hover">
                <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-edge="2"
                    ...
                    <div class="h-100">
                        <div
                            class="card bg-primary bg-opacity-10 border border-2 border-primary border-dashed border-opacity-75 rounded-3 h-100">
                            <div class="card-body">
                                <!-- Title -->
                    ...
                    <div class="h-100">
                        <div
                            class="card bg-info bg-opacity-10 border border-2 border-info border-dashed border-opacity-75 rounded-3 h-100">
                            <div class="card-body">
                                <!-- Title -->
