    ...
    <section class="pt-4">
        <div class="container">
            ...
            <div class="tiny-slider arrow-round arrow-blur">
                <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-edge="0"
                    data-dots="false" data-items="2" data-items-sm="1">
                    <!-- Slider item -->
                    <div>
                        <a class="w-100 h-100" data-glightbox data-gallery="gallery" href="/images/gallery/13.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="/images/gallery/13.jpg" class="rounded-3" alt="">
                                <!-- Full screen button -->
                    ...
                    <!-- Slider item -->
                    <div>
                        <a class="w-100 h-100" data-glightbox data-gallery="gallery" href="/images/gallery/16.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="/images/gallery/16.jpg" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <!-- Slider item -->
                    <div>
                        <a class="w-100 h-100" data-glightbox data-gallery="gallery" href="/images/gallery/11.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="/images/gallery/11.jpg" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                    ...
                    <!-- Slider item -->
                    <div>
                        <a class="w-100 h-100" data-glightbox data-gallery="gallery" href="/images/gallery/14.jpg">
                            <div class="card card-element-hover card-overlay-hover overflow-hidden">
                                <!-- Image -->
                                <img src="/images/gallery/14.jpg" class="rounded-3" alt="">
                                <!-- Full screen button -->
                                <div class="hover-element w-100 h-100">
                                    <i
                                        class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                    ...
                                    <div class="row g-3 g-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <a data-glightbox="" data-gallery="gallery"
                                                    href="/images/gallery/15.jpg"></a>
                                                <a data-glightbox="" data-gallery="gallery"
                                                    href="/images/gallery/16.jpg"></a>
                                            </div>
                                        </div>
                                ...
                                <div class="card border bg-transparent p-3">
                                    <div class="row g-3 g-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Image -->
                                            <div class="position-relative">
                                                <img src="/images/category/hotel/4by3/10.jpg" class="card-img"
                                                    alt="">
                                                <!-- Badge -->
                                                <div class="card-img-overlay">
                    ...
                    <div class="card bg-transparent border">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('second', ['hotel', 'booking']) }}"
                                    class="btn btn-dark mb-0">Continue To Book</a>
                            </div>
                        </div>
                        <!-- Card body END -->
                    </div>
