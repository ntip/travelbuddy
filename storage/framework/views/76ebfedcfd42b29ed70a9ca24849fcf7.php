                ...
                <div class="row g-4">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="nav flex-column text-primary-hover">
                            ...
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Sign in</a>
                            </li>
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Privacy
                                    Policy</a></li>
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Terms</a>
                            </li>
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Cookie</a>
                            </li>
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="nav flex-column text-primary-hover">
                            ...
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Indonesia</a>
                            </li>
                            <li class="nav-item"><a class="nav-link text-body-secondary" href="#">Canada</a>
                            </li>
        ...
        <div class="row g-4 justify-content-between mt-0 mt-md-2">
            ...
            <div class="col-sm-7 col-md-6 col-lg-4">
                ...
                <ul class="list-inline mb-0 mt-3">
                    <li class="list-inline-item"> <a href="#"><img src="/images/element/paypal.svg"
                                class="h-30px" alt=""></a></li>
                    <li class="list-inline-item"> <a href="#"><img src="/images/element/visa.svg"
                                class="h-30px" alt=""></a></li>
                    <li class="list-inline-item"> <a href="#"><img src="/images/element/mastercard.svg"
                                class="h-30px" alt=""></a></li>
                    <li class="list-inline-item"> <a href="#"><img src="/images/element/expresscard.svg"
                                class="h-30px" alt=""></a></li>
                </ul>
            </div>
...
</footer><?php /**PATH C:\Users\nickt\OneDrive\Documents\GitHub\travelbuddy\resources\views/layouts/partials/footer2.blade.php ENDPATH**/ ?>